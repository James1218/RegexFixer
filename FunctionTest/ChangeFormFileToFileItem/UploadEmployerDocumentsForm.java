...
public class UploadEmployerDocumentsForm extends BaseValidatorForm {
	...
	private FileItem employerUploadfile;
    ...
    public FileItem getEmployerUploadfile()
    {
		return employerUploadfile;
	}
	public void setEmployerUploadfile(FileItem employerUploadfile) {
		this.employerUploadfile = employerUploadfile;
	}
	public void setEmployerUploadfile(Object employerUploadfile){
		if(employerUploadfile!=null){
			List<FileItem>fileItems=(List<FileItem>)employerUploadfile;
