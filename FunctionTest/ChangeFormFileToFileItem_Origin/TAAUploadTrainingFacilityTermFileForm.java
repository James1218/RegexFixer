...
import gov.state.uim.domain.bean.UploadTrainingFacilityTermBean;
import gov.state.uim.framework.struts.BaseValidatorForm;

/**
 * @struts.form name = "taauploadtrainingfacilitytermfileform"
 */
public class TAAUploadTrainingFacilityTermFileForm extends BaseValidatorForm {
	private static final Logger LOGGER = Logger.getLogger(TAAUploadTrainingFacilityTermFileForm.class);


	private static final long serialVersionUID = 990123217636104666L;
	private FormFile fileName;
	private UploadTrainingFacilityTermBean lObjBean ;
