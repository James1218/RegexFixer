...
<%-- CIF_00350 End. --%>							
						...
						<html:link href="#"
							onclick="document.forms[0].method[0].click();window.open('${dua1View}','_blank','left=0,top=0,resizable=yes,scrollbars=yes,status=yes')">
...
<%-- modified new link and also condition --%>	
							<html:link href="#"
								onclick="document.forms[0].method[0].click();window.open('${dua12View}','_blank','left=0,top=0,resizable=yes,scrollbars=yes,status=yes')">
...
<c:param name="${access:encryptParams('encKey',encKey)}" value="${access:encryptParams(encKey,encKey)}" />
						...
						<html:link href="#"
							onclick="document.forms[0].method[0].click();window.open('${initialclaimforbenefits}','_blank','left=0,top=0,resizable=yes,scrollbars=yes,status=yes')">
...
//]]>
			...
			<tr>
				<td colspan="4">
					...
					<access:nonvalidatesubmit property="method"
